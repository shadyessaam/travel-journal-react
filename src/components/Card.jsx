  ...
  return (
    <div className='card'>
        ...
        <div className="card--data">
            <div className="card--data_location">
                ...
                <span className="card--data_location_country">
                    {props.location}
                </span>

                <span className='card--data_location_maps'>
                    <a href={props.googleMapsUrl}>View on Google Maps</a>
                </span>
            </div>

        <div className="card--data_title">{props.title}</div>
        
        <div className="card--data_date">
            {props.startDate} - {props.endDate} 
        </div>

        <div className="card--data_description">
            {props.description}
        </div>
